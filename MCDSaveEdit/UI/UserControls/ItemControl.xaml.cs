...
namespace MCDSaveEdit.UI
{
    ...
    {
        private static readonly BitmapImage? enchantmentPointsImageSource = ImageResolver.instance.imageSource("/Dungeons/Content/UI/Materials/Mobs/enchant_common_icon");
